...
export default function StudyHubPage() {
  ...
  return (
    <div className="flex-1 p-6 relative overflow-hidden flex flex-col h-full bg-[#0A0E17]">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 w-full max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Xin chào. Hôm nay bạn muốn nghiên cứu gì?</h1>
          <p className="text-slate-400">Trợ lý AI nội bộ đã kết nối với 12,400 chunk dữ liệu từ Kho Trí Thức.</p>
        </motion.div>
        ...
        >
          ...
          <div className="relative bg-[#0F141F] border border-slate-700 hover:border-cyan-500/50 transition-colors rounded-2xl p-2 flex items-center shadow-2xl">
            ...
            <input 
              ...
              placeholder="Hỏi về văn bản luật, yêu cầu viết code, tóm tắt tài liệu..."
        ...
        >
          <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-slate-800 bg-slate-900/50 hover:bg-slate-800 text-slate-400 hover:text-slate-200 text-sm transition-colors">
            <FileText className="w-4 h-4 text-emerald-400" /> Tóm tắt tài liệu Nghị Định 100
          </button>
          <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-slate-800 bg-slate-900/50 hover:bg-slate-800 text-slate-400 hover:text-slate-200 text-sm transition-colors">
            <Search className="w-4 h-4 text-purple-400" /> Tìm kiếm điều kiện hưởng BHXH
          </button>
          <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-slate-800 bg-slate-900/50 hover:bg-slate-800 text-slate-400 hover:text-slate-200 text-sm transition-colors">
            <BrainCircuit className="w-4 h-4 text-amber-400" /> Hỏi đáp bài giảng Generative AI
          </button>
        </motion.div>
      </div>
    </div>
