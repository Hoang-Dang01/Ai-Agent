...
class DbService {
    ...
    async initialize() {
        try {
            ...
            logger_1.logger.info('[DB Service] Ensuring task_fencing_seq sequence exists...');
        ...
        NO CYCLE;
      `);
            logger_1.logger.info('[DB Service] task_fencing_seq sequence checked/enabled successfully.');
        }
        catch (error) {
