...
const ACCOUNTS_FILE = path.join(__dirname, '../../storage/tool_mine_data/accounts.json');
const LOCATIONS_FILE = path.join(__dirname, '../../storage/tool_mine_data/locations.json');
